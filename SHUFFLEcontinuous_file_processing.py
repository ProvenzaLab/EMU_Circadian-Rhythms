...
def compute_patient_ch(file_name):
    ...
    if os.path.exists(f"chunks_power_continuous_SHUFFLED_new/{pat}_{ch}_powerSHUFFLED.csv"):
        return
    ...
    df_power.to_csv(f"chunks_power_continuous_SHUFFLED_new/{pat}_{ch}_powerSHUFFLED.csv",index=False)
