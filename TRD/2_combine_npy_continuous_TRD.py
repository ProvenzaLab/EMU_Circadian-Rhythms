...
PATH_NPY = Path("/mnt/labworlds/Provenza/EMU_Circadian-Rhythms/chunks_out_fixed")
OUT_PATH = Path("/mnt/labworlds/Provenza/EMU_Circadian-Rhythms/foundation_model_prep")
OUT_PATH.mkdir(exist_ok=True)

df_elecs = pd.read_csv("/mnt/labworlds/Provenza/EMU_Circadian-Rhythms/CSVs/combined_electrodes_MNI152.csv")
...
if __name__ == "__main__":
    ...
    for subject_dir in PATH_NPY.iterdir():
        ...
        #    continue
        if subject_dir.is_dir() and subject_dir.name.startswith("DBS"):
