...
PATH_DATA = "/mnt/datalake/data/TRD-43036"
PATH_OUT = "/mnt/labworlds/Provenza/EMU_Circadian-Rhythms/data_250Hz"
N_JOBS = 20  # joblib workers
FAIL_LOG = os.path.join(PATH_OUT, "failed_filesTRD014.txt")
...
def process_file(data_range_path: str, ns3_file: str, path_output: str, subject: str,read_ns3=True):
    ...
    try:
        ...
        if timestamp_str is None:
           ...
           log_fail(ns3_file_path, "SKIP_TOO_LONG")
           return
        ...
        try:
            ...
            log_fail(ns3_file_path, f"BRPYLIB_ERROR: neo={repr(e)} | brpylib={repr(e2)}")
            return
...
if __name__ == "__main__":
    ...
    for subject in subjects:
        ...
        subject_path_data = os.path.join(subject_path, "NEURAL")
    ...
    df_ns5.to_csv("ns5_files_to_process_TRD011.csv", index=False)
